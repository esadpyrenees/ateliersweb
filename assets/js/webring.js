var p = document.createElement('p'),
  ...
  css = '#webring { position: fixed; color: white; background: #000; bottom: 0; width: 100vw; left: 0; padding: 10px; display: flex; justify-content: space-between; } #webring a {flex: 1; color: white; text-decoration: none; font-size: 16px; font-family: sans-serif; text-align: center;}',
  links = [
