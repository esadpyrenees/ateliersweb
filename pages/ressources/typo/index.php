...
<h3>Accessibilité</h3>
            ...
            <p>
                Pour une meilleure accessibilité, une syntaxe plus complèe doit être saisie (et de nombreux fichiers doivent être présents):
            </p>
            <pre><code class="langage-css">@font-face {
    font-family: 'MyWebFont';
    font-weight:400; /* Graisse : regular */
    ...
    src: url('fonts/webfont-bold.eot?#iefix') format('embedded-opentype'),
        ...
        url('fonts/webfont-bold.svg#svgBoldFontName') format('svg'); 
            ...
            <p>
                ...
                D’autres services, tels <a href="http://typekit.com">Typekit</a> ou <a href="http://fonts.com" >fonts.com</a> permettent également d’intégrer des typos (moyennant paiement), parfois via l’insertion d’un script javascript.            
            </p>
            <p>
                Sur la page <a href="/web/fonderies/">ateliers.esapyrenees.fr/web/fonderies/</a> se trouve une liste de ces services.
            </p>
            <h3>Générer des webfonts</h3>
            <p>
                La page <a href="/web/fonderies/">ateliers.esapyrenees.fr/web/fonderies/</a> liste également quelques fonderies numériques libre ou open-source (<a href="http://velvetyne.fr/">Velvetyne</a>,
