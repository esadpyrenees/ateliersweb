...
#example-6 .ordering-example > div:nth-child(1) {
  ...
  <main class="pane active" id="content">
    ...
    <p>
      Les exemples ci-dessous sont repris – traduits et mis à jour – depuis un article paru sur tutsplus.com, <a href="https://code.tutsplus.com/tutorials/an-introduction-to-the-css-flexbox-module--net-25655">An Introduction to the CSS Flexbox Module</a>.
    </p>
        ...
        <section class="section example" id="example-1">
            ...
            <h2 class="section-subtitle">Appliquer flexbox comme propriété de display</h2>
            <p>
...
.enfant {
    flex-direction: column;
        ...
        <section class="section example" id="example-3">
            ...
            <p>
                La notion d’axe principal (et le pourquoi de <code>flex-start</code> et pas un hypothétique <code>flex-left</code>) est que le point de départ d’un texte n’est pas nécessairement la gauche. En arabe ou hébreu, le texte s’écrit de droite à gauche ; ce qui se code grace à un attribut <code>dir="rtl"</code>.
            </p>
