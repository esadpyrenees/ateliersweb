...
?>
  ...
  <section class="pane home" id="content">
    <div id="welcome" style="display:none">
      <svg viewBox="0 0 201 156" xmlns="http://www.w3.org/2000/svg" xmlns:svg="http://www.w3.org/2000/svg" preserveAspectRatio="none" >
        <g>
          <text xml:space="preserve" style="font-family:'Pappardelle'; fill:black; font-size:206px" x="0" y="155" id="text186">ateliers web</text>
        </g>
      </svg>
    </div>
